    ...
    fileslocation<- "/home/zerap/2006_2010/2011"
    ...
    First_D60 = Data_P[, .SD[Delq.Status<999 & Delq.Status >=2][,c("F60_DTE", "F60_UPB", "SPDelq3", "CountF2"):= 
                                                                   list(Monthly.Rpt.Prd, LAST_UPB, Delq.Status, Count)]][, .SD[1], by = "LOAN_ID"][,c("LOAN_ID", "F60_DTE", "F60_UPB", "SPDelq3", "CountF2"), with = FALSE, drop = FALSE]
    First_D90 = Data_P[, .SD[Delq.Status<999 & Delq.Status >=3][,c("F90_DTE", "F90_UPB", "SPDelq4", "CountF3"):= 
                                                                  list(Monthly.Rpt.Prd, LAST_UPB, Delq.Status, Count)]][, .SD[1], by = "LOAN_ID"][,c("LOAN_ID", "F90_DTE", "F90_UPB", "SPDelq4", "CountF3"), with = FALSE, drop = FALSE]
    ...
    Data_P[First_D60, c("F60_DTE", "F60_UPB", "SPDelq3", "CountF2"):=list(i.F60_DTE, i.F60_UPB, i.SPDelq3, i.CountF2)]
    Data_P[First_D90, c("F90_DTE", "F90_UPB", "SPDelq4", "CountF3"):=list(i.F90_DTE, i.F90_UPB, i.SPDelq4, i.CountF3)]
    ...
    rm("First_D180", "First_D60",'First_D90',"First_CE", "FMOD_DTE", "Performance_Variables", "Performance_ColClasses")
    ...
    ####################################################################
    write.csv(Combined_Data, '/home/zerap/2006_2010/2011/2011_data.csv')